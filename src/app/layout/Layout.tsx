...
export const Layout: FC<React.PropsWithChildren<unknown>> = ({ children }) => {
  ...
  const { isOpen: navIsOpen, onClose: navOnClose, onOpen: navOnOpen } = useDisclosure();
  ...
  return (
    <LayoutContext.Provider value={{ isFocusMode, setIsFocusMode, navIsOpen, navOnClose, navOnOpen }}>
      <Viewport>
